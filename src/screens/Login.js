...
export default class Login extends Component {
    ...
    async handleCreateAccountBtn() {
        const { userName, userEmail, userPassword, userConfirmPassword, userCity, userGender, userProfileImage, userTNC } = this.state;
    ...
    render() {
        const { isRegisterForm, showError, registerFormError, userTNC, userGender } = this.state;
        return (
            <div>
