...
export default class RegisterRestaurant extends Component {
    ...
    async handleCreateAccountBtn() {
        const { userName, userEmail, userPassword, userConfirmPassword, userCity, userGender, userTNC } = this.state;
        ...
        if (!userName.match(userNameFormate)) {
            ...
            // console.log(userName, userEmail, userPassword, userConfirmPassword, userCity, userGender, userAge, userProfileImage, userTNC)
            const userDetails = {
                userName: userName,
                userEmail: userEmail,
                userPassword: userPassword,
    ...
    render() {
        const { showError, registerFormError, userTNC, userGender } = this.state;
        return (
            <div>
